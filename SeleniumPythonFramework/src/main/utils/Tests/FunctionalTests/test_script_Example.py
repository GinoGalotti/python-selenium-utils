...
from SeleniumPythonFramework.src.main.utils.Actions.PageActionExample import HomePageActions
...
class TestSmoke(unittest.TestCase):
    def setUp(self):
        ...
        if testingbot_utils.check_using_tool():
            ...
            # This values can't be defined with Saucelab plugin
        ...
        Utils.set_mobile_view(self.test_context.mobile, self.test_context.driver)
    ...
    def test_try_out_magic_from_homepage(self):
        ...
        # And we are in HOME
        home_page_actions = HomePageActions(self.test_context)
